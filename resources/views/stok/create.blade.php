            ...
            function fetchProduk(search) {
                ...
                $.getJSON(url, function (result) {
                    ...
                    result.forEach((produk, index) => {
                        ...
                        row += `<button type="button" class="btn btn-xs btn-success" data-id="${produk.id}" data-nama="${produk.nama_produk}">`;
                        row += 'Add';
                        row += '</button>';
                        row += '</td>';
                        row += '</tr>';
                    ...
                    // Attach click event dynamically after creating buttons
                    $('#resultProduk button').click(function() {
                        addProduk($(this).data('id'), $(this).data('nama'));
                    });
                });
            }
