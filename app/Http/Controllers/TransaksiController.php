...
public function show(Request $request, Penjualan $transaksi)
{
    ...
    return view('transaksi.invoice', ['penjualan' => $transaksi, 'pelanggan' => $pelanggan, 'user' => $user, 'detilPenjualan' => $detilPenjualan]);
}
...
public function cetak(Penjualan $transaksi)
{
    ...
    return view('transaksi.cetak', ['penjualan' => $transaksi, 'pelanggan' => $pelanggan, 'user' => $user, 'detilPenjualan' => $detilPenjualan]);
}
